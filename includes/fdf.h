...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/08/16 15:07:43 by hwilderm          #+#    #+#             */
/*   Updated: 2019/08/24 15:33:46 by hwilderm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						get_color(t_dot current, t_dot start, t_dot end,
							t_dot delta);
...
t_dot					new_point(int x, int y, t_map *map);
